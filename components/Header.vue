<template>
    <div class="flex justify-between items-center">
        ...
        <div class="flex items-center space-x-6">
            ...
            <UBadge :ui="{ rounded: 'rounded-lg', icon: { base: 'flex-shrink-0 mr-0.5' } }" label="滑动卡片" color="gray" icon="hugeicons:touchpad-04"
                size="md" variant="soft" class="transform transition-all duration-500 ease-in-out select-none"
